      ...
      <main>
        <section className='d-xl-flex align-items-center col-lg-12 min-vh-100 room'>
          <div className='col-lg-6 room'>
            ...
            <div className='py-5 col-lg-12 d-xl-flex justify-content-start '>
            ...
            <div className='col-lg-12 d-flex'>
              <div className='col-lg-6'>
                  <h3 className='font_size'>Check-out</h3>
                </div>

                <div>
                  <h3 className='font_size'>Check-In</h3>
                </div>
            </div>
                  ...
                  <h3 className=' font_color px-5'>Check-In</h3>
                    ...
                    <div className='text-center py-5'>
                        ...
                        <div className='text-center px-5'>
                          <a className='div_w_four font_size font_color_one px-5' href="/login" role='button'>Formatos</a>
                        </div>
              ...
              <div className='col-lg-12 d-flex'>
                <div className='col-xl-8 bg_color_five'>
                  <div className='px-5 py-4'>
                    ...
                    <h3 className='font_size font_color px-5'>Reserva grupal</h3>
                        <p className='font_size_letter_one px-5'>Se diligencia únicamente si es una reservación grupal</p>
